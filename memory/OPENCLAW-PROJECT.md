...
| P60073 | [#65899](https://github.com/openclaw/openclaw/issues/65899) **P0 (🔥)** Hook error: Cannot access 'group' before initialization in message:sent | 🔥 **新发现**(方向1 第119轮 19:09 CST) | TDZ bug；内置 hook 代码 `const group` 在引用前未初始化；2026-04-11 起每条消息触发；**建议 aoao 立即接单** |
