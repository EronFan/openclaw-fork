...
| ⚠️ P60145 | [#66689](https://github.com/openclaw/openclaw/pull/66689) **🔒 SECURITY BLOCK** workspace media paths — Symlink escape allows arbitrary host file read | 🔒 **BLOCKED**（方向1 GitHub 第127轮 01:11 CST） | aisle-research-bot 报告 symlink escape → arbitrary host file read；`isPathInside` 检查在 `realpath` 前信任 path → 符号链接逃脱；**必须修复后再合并**；Greptile P1 |
